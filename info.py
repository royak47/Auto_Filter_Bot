...
PICS = (environ.get('PICS', 'https://i.ibb.co/kVFBm8XF/temp.jpg https://i.ibb.co/1JPpv6zd/temp.jpg https://i.ibb.co/FLgXNgtk/temp.jpg https://i.ibb.co/1G2G5wQm/temp.jpg https://i.ibb.co/Xk6K7s3Y/temp.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://graph.org/file/56b5deb73f3b132e2bb73.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/242b7f1b52743938d81f1.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://i.ibb.co/1G3W9BZV/temp.jpg https://i.ibb.co/4gsZmY3d/temp.jpg')).split()  # Fsub pic
...
# ============================
QR_CODE = environ.get('QR_CODE', 'free for now')    # QR code image for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sonukalakhari:sonukalakhari@cluster0.wrei3zt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://sonukalakhari76:sonukalakhari76@cluster0.c9zeoce.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
# Movie Notification & Update Settings
# ============================
MOVIE_UPDATE_NOTIFICATION = bool(environ.get('MOVIE_UPDATE_NOTIFICATION', True))  # Notification On (True) / Off (False)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002806046283'))  # Notification of sent to your channel
